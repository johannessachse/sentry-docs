...
When a pull request is opened, Sentry will parse the filenames and function names modified to find recent error issues associated with the code changes.

![Sentry comment on open pull request in GitHub](sentry-github-open-pr-comment.png)
